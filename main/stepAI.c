    ...
    if (code == LV_EVENT_CLICKED) {
        if (g_exchangeable_minutes > 0) {
            ...
            if (g_status_label) {
                ...
                lv_obj_set_style_text_color(g_status_label, lv_color_hex(0x00FF00), LV_PART_MAIN);
            }
            ...
            if (g_status_label) {
                ...
                lv_obj_set_style_text_color(g_status_label, lv_color_hex(0xFF0000), LV_PART_MAIN);
            }
        }
    }
}
...
static void create_ui(void)
{
    ...
    lv_obj_set_style_bg_color(exchange_container, lv_color_hex(0x16213E), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(exchange_container, LV_OPA_90, LV_PART_MAIN);
    lv_obj_set_style_border_color(exchange_container, lv_color_hex(0x0066FF), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(exchange_label, lv_color_hex(0xB0B0B0), LV_PART_MAIN);
    ...
    // Exchange value (large blue number)
    g_exchange_value_label = lv_label_create(exchange_container);
    char value_text[16];
    snprintf(value_text, sizeof(value_text), "%lu", g_exchangeable_minutes);
    lv_label_set_text(g_exchange_value_label, value_text);
    lv_obj_set_style_text_color(g_exchange_value_label, lv_color_hex(0x0066FF), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(exchange_unit_label, lv_color_hex(0x0066FF), LV_PART_MAIN);
    ...
    lv_obj_set_style_bg_color(exchange_btn, lv_color_hex(0x0066FF), LV_PART_MAIN);
    ...
    snprintf(steps_text, sizeof(steps_text), "Total: %lu steps", g_total_steps);
    lv_label_set_text(g_total_steps_label, steps_text);
    lv_obj_set_style_text_color(g_total_steps_label, lv_color_hex(0x888888), LV_PART_MAIN);
    ...
    snprintf(exchanged_text, sizeof(exchanged_text), "Exchanged: %lu min", g_exchanged_minutes);
    lv_label_set_text(g_exchanged_minutes_label, exchanged_text);
    lv_obj_set_style_text_color(g_exchanged_minutes_label, lv_color_hex(0x888888), LV_PART_MAIN);
    ...
    lv_obj_set_style_text_color(g_status_label, lv_color_hex(0x888888), LV_PART_MAIN);
